...
import type { BlogPublishStatus } from '@/stores/blogs/useBlogStore';

export interface BlogEditorPageTitleMetaProps {
...
export function BlogEditorPageTitleMeta({
  createdAt,
  draftVersionNumber,
  ...
  return (
    <div style={{ padding: '2px 0 10px', flexShrink: 0, display: 'flex', flexDirection: 'column' }}>
